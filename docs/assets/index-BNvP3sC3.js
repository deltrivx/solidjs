...
├── install.sh              # 安装脚本
└── info.json               # 插件元信息</pre><h2>四、从 Node 到 PM2 的迁移</h2><h3>4.1 原生的进程管理</h3><p>插件安装后 Gateway 由 <code>openclaw gateway</code> 直接启动，进程由宝塔插件 Python 后端管理。这种方式的问题是：</p><ul><li>进程崩溃后无法自动重启</li><li>日志管理不完善</li><li>重启需要进入插件面板操作</li></ul><h3>4.2 迁移到 PM2</h3><p>为了解决上述问题，将 Gateway 托管给 PM2：</p><pre># 1. 确认 Node.js 路径
which node
