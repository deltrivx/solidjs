...
export default function Projects() {
  const projects = [
    { icon: "📝", title: "DeltrivX Blog", desc: "赛博朋克风格个人博客，SolidJS + Vite + GitHub Pages + Cloudflare", tags: ["SolidJS","Vite","Cloudflare"], color: "linear-gradient(135deg,#6c5ce7,#a29bfe)", link: "https://github.com/deltrivx/solidjs", external: "" },
    ...
    { icon: "🪟", title: "宝塔面板", desc: "服务器管理面板 — baota.deltrivx.com", tags: ["Linux","运维"], color: "linear-gradient(135deg,#45aaf2,#2bcbba)", link: "https://baota.deltrivx.com", external: "https://baota.deltrivx.com" },
  ];
  return (
    <section id="projects">
