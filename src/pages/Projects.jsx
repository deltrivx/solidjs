    ...
    const projects = [
        {
            ...
            links: [{ url: "http://192.168.31.2:6880", label: "🎛️ AriaNg" }, { url: "http://192.168.31.2:8090", label: "⚡ qBittorrent" }, { url: "http://192.168.31.2:9091", label: "📡 Transmission" }, { url: "http://192.168.31.2:9091", label: "📡 Transmission" }, { url: "http://192.168.31.2:8080", label: "⚡ qBittorrent" }],
        },
        {
            icon: "🎬",
            name: "Emby 影音中心",
